  ...
  return (
    <section className="md:grid md:grid-cols-24">
      ...
      <div className="bg-softorange overflow-hidden min-h-dvh flex flex-col justify-center px-8 py-8 md:col-span-12 md:grid md:grid-cols-12 md:pl-0 md:pr-8 md:py-16">
        ...
        <h2 className="text-h3 font-display pr-16 md:col-start-2 md:col-span-10">
          {heading}
        </h2>

        {/* Body content - starts at col 4 */}
        <div className="text-paragraph ml-16 mt-20 max-w-96 space-y-6 md:col-start-4 md:col-span-7 md:ml-0 md:mt-36">
          {children}
        </div>
        ...
        <p className="text-small mt-2 ml-16 pt-2 md:col-start-4 md:col-span-7 md:ml-0">
          {name}
        </p>
      </div>
    </section>
