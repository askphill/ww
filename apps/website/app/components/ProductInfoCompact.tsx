...
export function ProductInfoCompact({
  subtitle,
  title,
  description,
  rating = 5,
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-between">
          <h1 className="text-h3 font-display uppercase">{title}</h1>
          {reviewCount > 0 && (
        ...
        {/* Subtitle */}
        <span className="text-body-small font-body italic text-text">
          {subtitle}
        </span>
      </div>

      {/* Description */}
      <p className="text-body-small font-display text-text">{description}</p>

      {/* Size Selection */}
      <div className="relative border-b border-black/20">
        <div className="flex items-center justify-between pb-3">
          <span className="text-body-small font-display">Size</span>
          <div className="flex items-center gap-4">
            {sizeOptions.map((option) => (
              <button
                ...
                className={`text-body-small font-display cursor-pointer transition-colors relative pb-3 -mb-3 ${
      ...
      {/* Benefits */}
      <div>
        <h3 className="text-body-small font-display pb-3 mb-3 border-b border-black/20">
          Benefits
        </h3>
          ...
          {badges.map((badge) => {
            ...
            return (
              <div key={badge} className="flex flex-col items-center gap-1.5">
                <BadgeIcon className="w-6 h-6 text-softorange" />
